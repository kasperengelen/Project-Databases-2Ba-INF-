...
class TestDataLoader(unittest.TestCase):
    ...
    def setUp(self):
        ...
        cur.execute("INSERT INTO SYSTEM.datasets VALUES(0, 0, 0)")
    ...
    def tearDown(self):
        ...
        self.db_connection.cursor().execute("DROP SCHEMA \"original_0\" CASCADE")
        self.db_connection.cursor().execute("DELETE FROM SYSTEM.datasets AS ds WHERE ds.setid = 0")
        self.db_connection.commit()
    ...
    def test_read_csv(self):
        ...
        self.db_connection.cursor().execute('SELECT table_name FROM information_schema.tables WHERE table_schema = \'0\' AND table_name = \'departments\' LIMIT 1;')
        self.assertEqual(self.db_connection.cursor().fetchone()[0], "departments")
        ...
        # test backup
        # test if table exists
        self.db_connection.cursor().execute('SELECT table_name FROM information_schema.tables WHERE table_schema = \'original_0\' AND table_name = \'departments\' LIMIT 1;')
        self.assertEqual(self.db_connection.cursor().fetchone()[0], "departments")
        # test contents of table
    ...
    def test_read_zip(self):
        ...
        # test if table exists
        self.db_connection.cursor().execute('SELECT table_name FROM information_schema.tables WHERE table_schema = \'0\' AND (table_name = \'test1\' OR table_name = \'test2\' OR table_name = \'test3\') LIMIT 3;')
        self.assertEqual(sorted(self.db_connection.cursor().fetchall()), [('test1',), ('test2',), ('test3',)])
        # test contents of table
        ...
        # test backup
        # test if table exists
        self.db_connection.cursor().execute('SELECT table_name FROM information_schema.tables WHERE table_schema = \'original_0\' AND (table_name = \'test1\' OR table_name = \'test2\' OR table_name = \'test3\') LIMIT 3;')
        self.assertEqual(sorted(self.db_connection.cursor().fetchall()), [('test1',), ('test2',), ('test3',)])
        # test contents of table
        self.db_connection.cursor().execute('SELECT * FROM "original_0"."test1" WHERE "original_0"."test1"."Col_2" = \'3\'')
        self.assertEqual(self.db_connection.cursor().fetchone(), ("2", "3", "4", "5"))
    ...
    def test_read_dump(self):
        ...
        # test if table exists
        self.db_connection.cursor().execute('SELECT table_name FROM information_schema.tables WHERE table_schema = \'0\' AND table_name = \'abc\' LIMIT 1;')
        self.assertEqual(self.db_connection.cursor().fetchone()[0], "abc")
        # test contents of table
        ...
        # test backup
        # test if table exists
        self.db_connection.cursor().execute('SELECT table_name FROM information_schema.tables WHERE table_schema = \'original_0\' AND table_name = \'abc\' LIMIT 1;')
        self.assertEqual(self.db_connection.cursor().fetchone()[0], "abc")
